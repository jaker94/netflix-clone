...
import { FaPlay, FaPlus, FaThumbsUp, FaVolumeOff, FaVolumeUp } from "react-icons/fa";
...
function Modal() {
  ...
  return (
    <MuiModal open={showModal} onClose={handleClose} className="fixed !top-7 left-0 
    right-0 z-50 mx-auto w-full max-w-5xl overflow-hidden overflow-y-scroll
    rounded-md scrollbar-hide">
      ...
      <div className="flex flex-col items-baseline space-x-16 space-y-2 rounded-b-md bg-[#181818] px-10
        py-8">
        <div className="text-lg">
            <div className="flex items-center space-x-2 text-sm">
                ...
                rounded border border-white/40 px-1.5 text-xs">HD</div>
            </div>
        </div>
